...
void menuGraficosPatrones() {
    ...
    do {
        ...
        switch(opcion) {
            ...
            case 9:
                cout << "\n*** EJECUTANDO TODOS LOS PATRONES ***\n" << endl;
                piramideAsteriscos(); patronesAlineados(); rectanguloHueco();
                tableroAjedrez(); patronesFormas(); trianguloFloyd();
                trianguloPascal(); patronZigzag();
